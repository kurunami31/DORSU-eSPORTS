...
const STEPS = [
  {
    icon: '📝',
    title: 'Register',
    desc: 'Sign up your team with captain info and roster. Slots fill fast — first come, first served.',
  },
  {
    icon: '🎲',
    title: 'We Draw Brackets',
    desc: 'Once registration closes, our engine randomly matches teams into a single-elimination bracket.',
  },
  {
    icon: '🏆',
    ...
    <>
      ...
      <section className="hero">
        <div className="container hero-inner">
          ...
          <h1 className="rise rise-1">
            Forge your <span className="grad">legacy</span>.
          </h1>
          <p className="lead rise rise-2">
            DOrSU eSPORTS is the official competitive gaming organization of Davao Oriental State
            University. Enter tournaments, get matched into brackets, and represent the Stallions
            on the stage.
          </p>
          <div className="hero-cta rise rise-3">
            <Link to="/register" className="btn btn-primary">⚡ Register Now</Link>
            <Link to="/tournaments" className="btn btn-ghost">View Tournaments</Link>
          </div>
      ...
      <section className="section" id="tournaments">
        <div className="container">
          <div className="section-head">
            ...
            <Link to="/tournaments" className="btn btn-ghost">All Tournaments →</Link>
          </div>
      ...
      <section className="section" style={{ background: 'var(--bg-1)', borderBlock: '1px solid var(--line)' }}>
        <div className="container">
          ...
          <div className="tournament-grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))' }}>
            {STEPS.map((s, i) => (
              <div key={s.title} className="card hover-lift" style={{ padding: 30, textAlign: 'center' }}>
                <div style={{ fontSize: 44, marginBottom: 14 }} aria-hidden="true">{s.icon}</div>
                <div
                  style={{
      ...
      <section className="section">
        <div className="container">
          <div className="section-head">
            ...
            <Link to="/announcements" className="btn btn-ghost">All Announcements →</Link>
          </div>
      ...
      <section className="section" style={{ paddingTop: 20 }}>
        <div className="container">
          ...
          >
            ...
            <Link to="/register" className="btn btn-primary">⚡ Register a Team</Link>
          </div>
        </div>
      </section>
    </>
